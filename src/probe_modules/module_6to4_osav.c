...
static tunnel_sav_profile_t profile = {
	...
	.outer_ipv6 = false,
	.inner_ipv6 = true,
	.module_name = "6to4_osav",
	.module_desc = "6to4 osav source-address validation scan module",
};

probe_module_t module_6to4_osav;

static int global_initialize(struct state_conf *conf)
{
	return tunnel_sav_common_global_initialize(&profile, &module_6to4_osav, conf);
}
