...
probe_module_t module_6to4_osav = {
	...
	.helptext = "6to4 osav SAV scanning module. Use --ipv6-target-file with csv rows 'ipv4,ipv6'. Packet build: outer src=local IPv4, outer dst=csv IPv4, inner src=--probe-args inner_src6, inner dst=local IPv6. Optional --probe-args result_csv=<path> to append matched payload v4,v6 pairs.",
};
