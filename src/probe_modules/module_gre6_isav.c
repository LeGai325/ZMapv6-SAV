...
static tunnel_sav_profile_t profile = {
	...
	.outer_ipv6 = true,
	.inner_ipv6 = true,
	.module_name = "gre6_isav",
	.module_desc = "gre6 isav source-address validation scan module",
};
...
{
	return tunnel_sav_common_global_initialize(&profile, &module_gre6_isav, conf);
}
...
probe_module_t module_gre6_isav = {
	...
	.helptext = "gre6 isav SAV scanning module. Output includes payload_outer_dst4/payload_outer_dst6 extracted from received payload for reliable matching. Optional --probe-args inner_dst4=,inner_dst6=,inner_src4=,inner_src6=",
};
