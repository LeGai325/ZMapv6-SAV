...
static tunnel_sav_profile_t profile = {
	...
	.proto = TUN_SAV_PROTO_GRE,
	.outer_ipv6 = false,
	.inner_ipv6 = false,
	.module_name = "gre_osav",
	.module_desc = "gre osav source-address validation scan module",
};
...
{
	return tunnel_sav_common_global_initialize(&profile, &module_gre_osav, conf);
}
...
probe_module_t module_gre_osav = {
	...
	.helptext = "gre osav SAV scanning module. Output includes original_target/icmp_type and payload_outer_dst4/payload_outer_dst6 extracted from received payload for reliable matching. Optional --probe-args inner_dst4=,inner_dst6=,inner_src4=,inner_src6=",
};
