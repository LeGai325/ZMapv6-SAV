...
static tunnel_sav_profile_t profile = {
	...
	.outer_ipv6 = false,
	.inner_ipv6 = false,
	.module_name = "gre_isav",
	.module_desc = "gre isav source-address validation scan module",
};
...
{
	return tunnel_sav_common_global_initialize(&profile, &module_gre_isav, conf);
}
...
probe_module_t module_gre_isav = {
	...
	.helptext = "gre isav SAV scanning module. Output includes payload_outer_dst4/payload_outer_dst6 extracted from received payload for reliable matching. Optional --probe-args inner_dst4=,inner_dst6=,inner_src4=,inner_src6=",
};
