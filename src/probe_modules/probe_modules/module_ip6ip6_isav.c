...
static tunnel_sav_profile_t profile = {
	...
	.proto = TUN_SAV_PROTO_IP6IP6,
	.outer_ipv6 = true,
	.inner_ipv6 = true,
	.module_name = "ip6ip6_isav",
	.module_desc = "ip6ip6 isav source-address validation scan module",
};

probe_module_t module_ip6ip6_isav;

static int global_initialize(struct state_conf *conf)
{
	return tunnel_sav_common_global_initialize(&profile, &module_ip6ip6_isav, conf);
}
...
probe_module_t module_ip6ip6_isav = {
	...
	.helptext = "ip6ip6 isav SAV scanning module. Output includes payload_outer_dst4/payload_outer_dst6 extracted from received payload for reliable matching. Optional --probe-args inner_dst4=,inner_dst6=,inner_src4=,inner_src6=",
};
