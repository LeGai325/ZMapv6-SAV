...
static tunnel_sav_profile_t profile = {
	...
	.outer_ipv6 = true,
	.inner_ipv6 = true,
	.module_name = "ip6ip6_osav",
	.module_desc = "ip6ip6 osav source-address validation scan module",
};
...
{
	return tunnel_sav_common_global_initialize(&profile, &module_ip6ip6_osav, conf);
}
...
probe_module_t module_ip6ip6_osav = {
	...
	.helptext = "ip6ip6 osav SAV scanning module. Uses minimal ICMP/ICMPv6 payload carrying only outer destination address for reply mapping; outputs original_target/icmp_type. Optional --probe-args inner_dst4=,inner_dst6=,inner_src4=,inner_src6=",
};
